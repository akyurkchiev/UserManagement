    ...
    <body ng-app="myApp" class="ng-cloak">
        <div class="generic-container" ng-controller="UserController as ctrl">
            <div class="panel panel-default">
                <div class="panel-heading"><span class="lead">User information </span></div>
                    ...
                    <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="col-md-7">
                                    <input type="text" ng-model="ctrl.user.firstname" name="fname" onfocusout="" class="username form-control input-sm" placeholder="Enter first name" required ng-minlength="3"/>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="col-md-7">
                                    <input type="text" ng-model="ctrl.user.lastname" name="lname" class="username form-control input-sm" placeholder="Enter last name" required ng-minlength="3"/>
                                    <div class="has-error" ng-show="myForm.$dirty">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="col-md-7">
                                    <input type="date" ng-model="ctrl.user.dob" name="dob" placeholder="Enter birth date" class="form-control input-sm" />
                                    <div class="has-error" ng-show="myForm.$dirty">
                                        <span ng-show="myForm.dob.$error.required">This is a required field</span>
                                        <span ng-show="myForm.dob.$error.minlength">Not a valid date</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr ng-repeat="u in ctrl.users">
                                ...
                                <td><span ng-bind="u.dob | date: 'yyyy/MM/dd'"></span></td>
